...
describe("SignUp (Frontend only)", () => {
    ...
    it("renders form elements and has Login link", () => {
        render(
            <MemoryRouter>
                <SignUp />
            </MemoryRouter>
    ...
    it("validate: shows error when required fields are empty", async () => {
        render(
            <MemoryRouter>
                <SignUp />
            </MemoryRouter>
    ...
    it("clears previous validation error after user fixes input", async () => {
        render(
            <MemoryRouter>
                <SignUp />
            </MemoryRouter>
    ...
    it("calls fetch with correct params when onSubmit prop is absent", async () => {
        mockFetchOnce({ success: false, message: "x" });
    ...
    it("API success: stores user in localStorage and calls onSignUpSuccess", async () => {
